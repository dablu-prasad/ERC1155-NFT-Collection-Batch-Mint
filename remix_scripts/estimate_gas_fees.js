...
(async () => {
    try {
        ...
        const contractName = 'FlowerCollection'; // Change this for other contract
        const contract_address = '0x0adfa76De007c0F68eB157B5611Aba0A57cB8313';
        ...
        const ids = getTokenIds(1, 43);
        const amounts = getAmounts(43);
